  ...
  apps: [
    {
      ...
      paragraph: "Utilizing WMATA's public API, Metrobus 2020 allows DC-based commuters to accurately predict bus and train arrivals, favorite their frequent stations and busstops, and set an alarm for when a bus approaches a stop. The app uses an uncluttered minimalist frontend written in vanilla JavaScript with Bulma components. The rails backend protects API keys and fetches data from WMATA. A simple sign-up and password system allows users' favorites to be persisted to the database for future use in the app.",
